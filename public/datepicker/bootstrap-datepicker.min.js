...
(function ($, undefined) {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _generateHTML: function (e) {
            ...
            var g = this._canAdjustMonth(e, -1, d, p) ? '<a class="ui-datepicker-prev btn btn-link" data-handler="prev" data-event="click"' + ' title="' + m + '">' + (n ? '<i class="icon-circle-arrow-right fas fa-arrow-right"></i>' : '<i class="icon-circle-arrow-right fas fa-arrow-left"></i>') + "</a>" : i ? "" : '<a class="ui-datepicker-prev btn btn-link ui-state-disabled" title="' + m + '">' + (n ? '<i class="icon-circle-arrow-right fas fa-arrow-right"></i>' : '<i class="icon-circle-arrow-right fas fa-arrow-left"></i>') + "</a>";
            ...
            var b = this._canAdjustMonth(e, +1, d, p) ? '<a class="ui-datepicker-next btn btn-link" data-handler="next" data-event="click"' + ' title="' + y + '">' + (n ? '<i class="icon-circle-arrow-right fas fa-arrow-left"></i>' : '<i class="icon-circle-arrow-right fas fa-arrow-right"></i>') + "</a>" : i ? "" : '<a class="ui-datepicker-next btn btn-link ui-state-disabled" title="' + y + '">' + (n ? '<i class="icon-circle-arrow-right fas fa-arrow-left"></i>' : '<i class="icon-circle-arrow-right fas fa-arrow-right"></i>') + "</a>";
